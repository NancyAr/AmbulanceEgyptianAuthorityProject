...
<link href="{{'css/Replies.css'}}" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
<div id="wrapper">
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="card" >
					<div style="clear: both;">&nbsp;</div>
						<h2 class="title"><a href="#"> {{$HospitalName->HospitalName}} </a></h2>
						<p class="meta"><span class="date">{{$Replies->created_at}}</span>
						...
						<div class="card-body card-block"> 
							...
							@if($comment->InquiryID == $Replies->id)
                               
                                    <div class = "comments" style = "background-color:white;">
                                        <a> <span id ="comment-user"></span>  {{$comment->Description}}</a>
